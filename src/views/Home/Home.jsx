...
function Home() {
    ...
    return (
        <motion.div
            className='dark flex flex-col flex-shrink justify-center items-center h-[90%] p-1 md:p-6 md:h-full md:w-full'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            ...
            <div className='flex flex-col text-[var(--creamy)] h-[100%] p-2 w-[92%] border-solid rounded-xl bg-[var(--creamy)] dark:bg-[var(--wash-black)] shadow-lg shadow-black'>
