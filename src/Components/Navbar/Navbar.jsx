      ...
      <div className="dark flex md:flex-col flex-wrap md:flex-nowrap items-center justify-center p-4 h-full">
        ...
        <div className={"hidden w-full h-full self-center md:block text-center flex-shrink outline-none"}>
          <ul className="font-medium text-base h-full flex flex-col outline-none flex-shrink justify-around items-center p-7 mt-2 border-0 rounded-xl bg-gray-50 dark:bg-[var(--wash-black)] shadow-lg shadow-black">
            <li>
              <Link to="/home/stats" className={`flex flex-col justify-center items-center rounded-lg transition duration-150 ease-in-out hover:ease-in py-2 pl-3 pr-4 focus:pr-12 active:pr-12 ${(location.includes("home")) ? `bg-[var(--goblin-green)] text-black pr-12` : `hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white`} `}>
            ...
            <li>
              <Link to="/users" className={`flex flex-col justify-center items-center rounded-lg transition duration-150 ease-in-out hover:ease-in py-2 pl-3 pr-4 focus:pr-12 active:pr-12 ${(location === "/users") ? `bg-[var(--goblin-green)] text-black pr-12` : `hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white`} `}>
            ...
            <li>
              <Link to="/config" className={`flex flex-col justify-center items-center rounded-lg transition duration-150 ease-in-out hover:ease-in py-2 pl-3 pr-4 focus:pr-12 active:pr-12  ${(location === "/config") ? `bg-[var(--goblin-green)] text-black pr-12` : `hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white`} `}>
            ...
            <li>
              <Link to="/about" className={`flex flex-col justify-center items-center rounded-lg transition duration-150 ease-in-out hover:ease-in py-2 pl-3 pr-4 focus:pr-12 active:pr-12 ${(location === "/about") ? `bg-[var(--goblin-green)] text-black pr-12` : `hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white`}`}>
